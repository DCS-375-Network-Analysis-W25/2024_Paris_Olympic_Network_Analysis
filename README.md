...
&nbsp;&nbsp;&nbsp;&nbsp;Using this Japan medalist network, I have decided to do statistical analysis. I have measured the Edge Density, Transitivity, and Betweenness, and I am refering the strategy mentioned in _Chapter 2: The Network Analysis `Five-Number Summary'_ of  _A User’s Guide to Network Analysis in R.pdf_ by 
